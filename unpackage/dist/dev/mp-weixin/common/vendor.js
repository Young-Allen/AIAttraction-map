...
function StringToTime(time) {
  var dateTimeStr = time; // 日期时间字符串
  var date = new Date(dateTimeStr); // 构造 Date 对象
  var year = date.getFullYear(); // 获取年份
  var month = date.getMonth() + 1; // 获取月份，需要加1，因为月份是从0开始计数的
  var day = date.getDate(); // 获取日期
  var hour = date.getHours(); // 获取小时
  var minute = date.getMinutes(); // 获取分钟
  var second = date.getSeconds(); // 获取秒数

  var formattedDateTime = "".concat(year, "-").concat(month.toString().padStart(2, '0'), "-").concat(day.toString().padStart(2, '0'), " ").concat(hour.toString().padStart(2, '0'), ":").concat(minute.toString().padStart(2, '0'), ":").concat(second.toString().padStart(2, '0'));
...
/***/ 26:
/*!*************************************************!*\
  !*** F:/Studying Code/小程序/uni-map02/pages.json ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 33:
/*!*****************************************************!*\
  !*** F:/Studying Code/小程序/uni-map02/store/store.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 35:
/*!****************************************************!*\
  !*** F:/Studying Code/小程序/uni-map02/store/user.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  mutations: {
    ...
    updateUserPosition: function updateUserPosition(state, position) {
      state.userPosition = position;
      this.commit('m_user/saveUserPositionToStorage');
    },
    saveUserPositionToStorage: function saveUserPositionToStorage(state) {
...
/***/ 36:
/*!*******************************************************!*\
  !*** F:/Studying Code/小程序/uni-map02/store/roadMsg.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  mutations: {
    ...
    saveActivePointToStorage: function saveActivePointToStorage(state) {
      uni.setStorageSync('activePoint', state.activePoint);
    },
    // 更新当前线路的当前景点下标
    updateActivePoint: function updateActivePoint(state, activePoint) {
    ...
    updatePointList: function updatePointList(state, e) {
      state.roadList.forEach(function (item) {
        if (item.roadName === e) {
  ...
  // 数据包装器
  getters: {
    roadNameList: function roadNameList(state) {
      var c = [];
      state.roadList.forEach(function (item) {
...
/***/ 37:
/*!********************************************************!*\
  !*** F:/Studying Code/小程序/uni-map02/store/settings.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  mutations: {
    ...
    saveIsShowModalToStorage: function saveIsShowModalToStorage(state) {
      uni.setStorageSync('isShowModal', state.isShowModal);
    },
    // 更新当前线路的当前景点下标
    updateIsShowModal: function updateIsShowModal(state, isShowModal) {
...
function mapping(_this) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (data[i].labelName.length < 6) {
      ...
      context.fillText(data[i].labelName.substring(0, 3), data[i].x - data[i].size * (0.5 * data[i].labelName.substring(0, 3).length), data[i].y + data[i].size * 0.5 - data[i].size * 0.8);
      context.fillText(data[i].labelName.substring(3, 6), data[i].x - data[i].size * (0.5 * data[i].labelName.substring(3, 6).length), data[i].y + data[i].size * 0.5 + data[i].size * 0.8);
    }
  }
  context.draw();
}
...
var userApi = {
  ...
  //更新用户信息
  updateUserInfo: function updateUserInfo(datas) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              query = datas;
              _context2.next = 3;
              return uni.$http.put('/api/user/update', query);
            case 3:
              res = _context2.sent;
      ...
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return uni.$http.get('/api/user/userinfo');
            case 2:
              res = _context3.sent;
      ...
      return _regenerator.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return uni.$http.get('/api/user/allTag');
            case 2:
              res = _context4.sent;
...
var articleApi = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return uni.$http.get('/api/article/all', query);
            case 3:
              res = _context.sent;
  ...
  //根据id获取热门攻略
  getArticleById: function getArticleById(index) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var query, res;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              query = BigInt(index);
              _context2.next = 3;
              return uni.$http.get("/api/article/".concat(query));
            case 3:
              res = _context2.sent;
...
var roadApi = {
  ...
  //根据Id获取静态线路
  getStaticRoadById: function getStaticRoadById(id) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var res;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
...
function getSwiperList(list) {
  ...
  var leftPlusList = (0, _toConsumableArray2.default)(list).reverse().slice(0, plus).reverse();
  var rightPlusList = (0, _toConsumableArray2.default)(list).slice(0, plus);
...
var tourgroupApi = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              query = datas;
              _context.next = 3;
              return uni.$http.post('/api/tourgroup/create', query);
            case 3:
              res = _context.sent;
              return _context.abrupt("return", res.data.data);
            case 5:
  ...
  //加入群组
  joinGroup: function joinGroup(inviteCode) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var query, res;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return uni.$http.get('/api/tourgroup/join', query);
            case 3:
              res = _context2.sent;
              return _context2.abrupt("return", res.data.data);
            case 5:
  ...
  //获取群组详情信息
  tourGroupInfo: function tourGroupInfo() {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
      var res;
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return uni.$http.get('/api/tourgroup/info');
            case 2:
              res = _context3.sent;
  ...
  //获取所有群组详情信息
  tourGroupsInfo: function tourGroupsInfo() {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
      var res;
      return _regenerator.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return uni.$http.get('/api/tourgroup/all');
            case 2:
              res = _context4.sent;
              return _context4.abrupt("return", res.data.data);
            case 4:
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return uni.$http.get('/notice/public', query);
            case 3:
              res = _context5.sent;
              return _context5.abrupt("return", res.data.data);
            case 5:
  ...
  //获取群组的历史消息
  getGroupNotices: function getGroupNotices() {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6() {
      var query, res;
      return _regenerator.default.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return uni.$http.get('/notice/group', query);
            case 3:
              res = _context6.sent;
  ...
  //根据id获取历史消息
  getNoticeById: function getNoticeById(id) {
      ...
      return _regenerator.default.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return uni.$http.get("/notice/".concat(id));
            case 2:
              res = _context7.sent;
