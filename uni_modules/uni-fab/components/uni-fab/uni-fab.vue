<template>
  <view class="uni-cursor-point">
    ...
    <view :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
		}" class="uni-fab__circle uni-fab__plus midType"
      :style="{ 'background-color': styles.buttonColor, 'bottom': nvueBottom }" @click="_onClick">
      <uni-icons class="fab-circle-icon" type="navigate" :color="styles.iconColor" size="32"
        :class="{'uni-fab__plus--active': isShow && content.length > 0}"></uni-icons>
      <text style="color: white; font-size: 10px;">线路</text>
